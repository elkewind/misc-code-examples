...
I use the mpa layer to remove locations from the habitat map within any mpa. In this case, there was only one suitable location within an mpa. I then convert to point data to map.
