...
Let's explore the cropland use in Iowa in 2003 and cropland use in Iowa in 2022.
...
Let’s explore the cropland use in Iowa in 2003 (left) and cropland use in Iowa in 2022 (right) at the same time.

```{python}
# # Create basemap centered around iowa
# Map_split = geemap.Map()
# Map_split.addLayer(iowa)
# Map_split.centerObject(iowa, 6)
# 
# # Change basemap
# Map_split.add_basemap('SATELLITE')
# 
# # Add layer for 2003
# left = geemap.ee_tile_layer(cropland_03, crop_vis, 'Landcover')
# 
# # Add layer for 2022
# right = geemap.ee_tile_layer(cropland_22, crop_vis, 'Landcover')
# 
# # Add tiles to the map
# Map_split.split_map(left, right)
# 
# # Add legend
# Map_split.add_legend(title="USDA Land and Crop Classification", builtin_legend='USDA/NASS/CDL')
# 
# Map_split # view map
```
