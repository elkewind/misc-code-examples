...
I start by loading necessary packages. I need *readr*, *dplyr*, and *ggplot* from the tidyverse, so I chose to load the *tidyverse* packages to read, clean, and plot data.
...
```{r echo=FALSE, output=TRUE, fig.width=11.35, fig.height=35, out.width="100%", out.height="100%"}
library(cowplot)
